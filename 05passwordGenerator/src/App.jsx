  ...
  return (
    <>
      ...
      px-4 py-3 my-8 bg-gray-800 text-orange-500'>
        ...
        <div className='flex shadow bg-white text-grey-500 rounded-lg overflow-hidden mb-4'>
          <input 
            type="text" 
            value={Password}
            className='outline-none w-full px-1 py-3 bg-white text-gray-800'
            placeholder='Password will be generated here'
            readOnly
            ref={passwordRef}
            style={{ color: Password ? undefined : undefined }}
          />
          <button
